...
class BinarySearchTree(object):
    ...
    def search(self, item):
        ...
        TODO: Best case running time: O(1) if the item is at the root
        TODO: Worst case running time: O(log n) The item is not found"""
        # Find a node with the given item, if any
        node = self._find_node_recursive(item, self.root)
    ...
    def _find_parent_node_recursive(self, item, node, parent=None):
        ...
        # TODO: Check if the given item is less than the node's data
            ...
            if node.left is not None:
                return self._find_parent_node_recursive(item, node.left)  # Hint: Remember to update the parent parameter
            else:
                return node
        # TODO: Check if the given item is greater than the node's data
        elif item > node.data:
            ...
            # TODO: Recursively descend to the node's right child, if it exists
                return self._find_parent_node_recursive(item, node.right)  # Hint: Remember to update the parent parameter
            else:
                return node
